...
class SmartHomeLexer:
    ...
    def _clasificar(self, palabra: str) -> tuple:
        ...
        carácter de distancia de alguna palabra reservada del lenguaje, se devuelve el tipo
        ...
        # 5. Palabra reservada MAL ESCRITA 
    ...
    def _validar_rango(self, tok: Token) -> None:
        ...
        # 2. Validación de rango ESPECÍFICO 
